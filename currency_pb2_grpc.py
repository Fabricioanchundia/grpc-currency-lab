...
class CurrencyConverterStub:
    ...
    def __init__(self, channel):
        ...
        self.Suma = channel.unary_unary(
                '/currency.CurrencyConverter/Suma',
                request_serializer=currency__pb2.SumaRequest.SerializeToString,
                response_deserializer=currency__pb2.SumaReply.FromString,
                _registered_method=True)


class CurrencyConverterServicer:
    """Missing associated documentation comment in .proto file."""
    ...
    def GetRate(self, request, context):
        """Desafío: devuelve solo la tasa de cambio, sin convertir una cantidad
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def Suma(self, request, context):
        """Actividad: suma dos números (ejemplo de RPC unary simple)
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CurrencyConverterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Suma': grpc.unary_unary_rpc_method_handler(
                    servicer.Suma,
                    request_deserializer=currency__pb2.SumaRequest.FromString,
                    response_serializer=currency__pb2.SumaReply.SerializeToString,
            ),
    }
...
class CurrencyConverter:
    ...
    def Suma(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/currency.CurrencyConverter/Suma',
            currency__pb2.SumaRequest.SerializeToString,
            currency__pb2.SumaReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
